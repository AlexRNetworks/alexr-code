document.addEventListener('DOMContentLoaded', () => {
    ...
    function applyInitialEditorSettings() {
        ...
        // Set CodeMirror theme for initial options
        initialCodeMirrorOptions.theme = savedCmTheme;

        // Update select/input elements in settings modal if they exist
...
`body { 
    ...
    margin: 20px; 
    text-align: center; 
    /* background-color: #f0f2f5; /* Preview body will inherit from main page via JS if possible */
    /* color: #333; */
}
h1 { color: #007aff; }
...
// console.error("This is a test error for the custom console.");
// To test runtime error: undefinedFunctionToTestOnError(); 
`
        );
        externalCSS = []; 
        externalJS = [];
        ...
        // Apply default/global editor appearance settings when setting initial content
        ...
        // Update settings modal display to reflect these defaults
