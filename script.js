document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log("Alexr Code script.js: DOMContentLoaded - Linting Re-integration.");
    ...
    function applyInitialEditorSettings() {
        ...
        baseCodeMirrorOptions.theme = savedCmTheme;
    ...
    const baseCodeMirrorOptions = { 
        ...
        lineWrapping: true,
        gutters: ["CodeMirror-linenumbers", "CodeMirror-lint-markers"] // Gutter for lint markers
    };
    ...
    try {
        htmlEditor = CodeMirror.fromTextArea(document.getElementById('html-code'), {
            ...
            mode: 'htmlmixed',
            lint: true // Use the html-lint.js connector which uses the global HTMLHint object
        });
        cssEditor = CodeMirror.fromTextArea(document.getElementById('css-code'), {
            ...baseCodeMirrorOptions, 
            mode: 'css',
            lint: true // Use the css-lint.js connector which uses the global CSSLint object
        });
        jsEditor = CodeMirror.fromTextArea(document.getElementById('js-code'), {
            ...baseCodeMirrorOptions, 
            mode: 'javascript',
            lint: { // Pass specific options to the javascript-lint.js connector (for JSHint)
                options: {
                    esversion: 2021, 
                    browser: true,   
                    undef: true,     
